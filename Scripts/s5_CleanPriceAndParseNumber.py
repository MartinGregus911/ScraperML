...
df = pd.read_csv("/data/processed/active_cleanable_listings.csv")
...
df_cleaned.to_csv("/data/processed/cleaned_listings.csv", index=False)
df_dropped.to_csv("/data/processed/dropped_rows_log.csv", index=False)
